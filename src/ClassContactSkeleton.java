/**
 *Class skeleton for class Contact
 *
 * One object of the class Contact represents one contact, with the
 * following information:
 *
 * First name, last name, address, e-mail address, phone number, and notes.
 */
